...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Bittle.absolute_url'
        db.alter_column(u'django_bitly_bittle', 'absolute_url', self.gf('django.db.models.fields.URLField')(max_length=1024))

    def backwards(self, orm):

        # Changing field 'Bittle.absolute_url'
        db.alter_column(u'django_bitly_bittle', 'absolute_url', self.gf('django.db.models.fields.URLField')(max_length=200))
